...
public class CommerceController extends BaseController {
    ...
    @ApiOperation(value = "根据部门查询当前部门下所有工商注册跟进流程",notes = "根据部门ID查询工商注册跟进流程")
    public Result<MyPageInfo<String, Integer, FollowUpQueryVo>> listProcessByDepartmentId(FollowUpQueryVo followUpQueryVo) {
        ...
        try {
            MyPageInfo<String,Integer,FollowUpQueryVo>	varList = commerceService.listProcessByDepartmentId(followUpQueryVo);
